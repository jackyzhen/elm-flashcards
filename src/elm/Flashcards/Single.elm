...
view flashcard =
    div [ class "container section" ]
        ...
        , p [ class "control" ]
            [ input [ onInput UpdateSubject, class "input", type_ "text", placeholder "Maths..", value flashcard.currentEditCard.subject ] []
            ]
        , label [ class "label" ] [ text "Question" ]
        , p [ class "control" ]
            [ input [ onInput UpdateQuestion, class "input", type_ "text", placeholder "What is 2+2?", value flashcard.currentEditCard.question ] []
            ]
        , label [ class "label" ] [ text "Answer" ]
        , p [ class "control" ]
            [ input [ onInput UpdateAnswer, class "input", type_ "text", placeholder "2+2 = 4?", value flashcard.currentEditCard.answer ] []
            ]
